...
class ProductController extends GetxController {
  ...
  Future<void> fetchCartProducts() async {
    try {
      List<Product> fetchedCartProducts =
          await firestoreProducts.getCartProducts();
  ...
  void isFavorite(int index) {
    ...
    firestoreProducts.updateProduct(productName, newIsFavoriteValue).then(
      (_) {
  ...
  void addToCart(Product product) {
    ...
    firestoreProducts.saveCartItems(cartProducts);
  }
