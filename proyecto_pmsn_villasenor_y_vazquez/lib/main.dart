...
import 'package:proyecto_pmsn_villasenor_y_vazquez/src/firebase/ForGroundLocalNotification.dart';
import 'package:proyecto_pmsn_villasenor_y_vazquez/src/firebase/getfcm.dart';
...
void main() async {
  ...
  String? formKey = await getFcmToken();
  print('FCM key: $formKey');
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    LocalNotificacion.initialize();
    FirebaseMessaging.onMessage.listen(
      (RemoteMessage message) {
        LocalNotificacion.showNotification(message);
      },
    );
